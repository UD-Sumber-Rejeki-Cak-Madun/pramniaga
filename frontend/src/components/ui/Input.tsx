/**
 * Purpose: Labeled text input with inline error.
 * Exports: Input
 *
...
/**
 * Input - Labeled text input with optional error text.
 *
 * @param props - Native input attributes plus label and error.
 * @param props.label - Optional field label.
 * @param props.error - Optional error message shown below the input.
